          ...
          <div className="login-card">
            <div className="social-buttons">
              {isLoading.google ? (
                ...
                <GoogleLogin onSuccess={handleLoginSuccess} onError={() => console.log('Google login failed')} />
              )}

              <button disabled={isLoading.google || isLoading.microsoft} className="social-button">
                {isLoading.microsoft ? (
                  <div className="spinner"></div>
                ) : (
                  <>
